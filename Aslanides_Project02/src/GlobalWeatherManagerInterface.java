...
public interface GlobalWeatherManagerInterface {
     ...
     */
    WeatherReading getReading(int index);
     ...
     */
    WeatherReading[] getReadings(int index, int count);
     ...
     */
    WeatherReading[] getReadings(int index, int count, int month, int day);
     ...
     */
    CityListStats getCityListStats(String country, String state, String city);

    /**
     * Retrieves an iterator over all weather readings.
     * @return      strongly typed iterator for.
     */
    Iterator<WeatherReading> iterator();
     ...
     */
    double getTemperatureLinearRegressionSlope(WeatherReading[] readings);
     ...
     */
    double calcLinearRegressionSlope(Integer[] x, Double[] y);
